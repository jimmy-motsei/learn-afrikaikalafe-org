...
export const presenters: Presenter[] = [
  {
    ...
    track:       'convenor',
    title:       'Nurse, Author & African Healing Justice Pioneer',
    location:    'South Africa',
    countryCode: 'ZA',
    bio:         'Founder of Afrika Ikalafe Pluriversity and pioneer of African healing justice, Mmatshilo is a nurse, midwife, social researcher and author of six books. Three decades of transformative activism — from founding ADAPT in Alexandra Township to the UN Scroll of Honour and two Honorary Doctorates — have placed her at the forefront of womb-centred, community-rooted healing.',
    gathering:   1,
