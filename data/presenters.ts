...
export const presenters: Presenter[] = [
  {
    ...
    track:       'convenor',
    title:       'Physician, Author & Land-Based Healer',
    location:    'South Africa',
    countryCode: 'ZA',
    bio:         'Dr Mmatshilo Motsei is the founder of Afrika Ikalafe Pluriversity — a centre for land-based healing, learning and living. A physician, author, and cultural activist, she holds the vision of womb-centred healing across the African continent and diaspora. She convenes and facilitates the entire programme, opening the series with Gathering 1.',
    gathering:   1,
